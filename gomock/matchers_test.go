...
//go:generate sqlmockgen -destination internal/mock_gomock/mock_matcher.go github.com/guzenok/go-sqltest/gomock Matcher
...
import (
	...
	"github.com/guzenok/go-sqltest/gomock/internal/mock_gomock"
)
