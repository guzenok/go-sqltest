...
import (
	...
	"github.com/guzenok/go-sqltest/mockgen/internal/tests/custom_package_name/client/v1"

	//  matching import suffix and package name
	"github.com/guzenok/go-sqltest/mockgen/internal/tests/custom_package_name/validator"
)
