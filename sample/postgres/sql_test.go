...
func testStoreUsersMock() (*sql.DB, error) {
...
RETURNING created_at;`).WithArgs(
		...
		rr.AddRow(time.Unix(1574612209, 615692000))
		return rr
	}())
	mock.ExpectCommit()
	mock.ExpectBegin()
...
LIMIT 1;`).WithArgs(
		...
		rr.AddRow(1, "third-P", time.Unix(1574612209, 615692000), false)
		return rr
	}())
	mock.ExpectQuery(`
...
LIMIT 1;`).WithArgs(
		...
		rr.AddRow("user01", "third-P", time.Unix(1574612209, 615692000), false)
		return rr
	}())
