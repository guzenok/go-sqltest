//go:generate sqlmockgen -source greeter.go -destination greeter_mock_test.go -package greeter
...
import (
	...
	"github.com/guzenok/go-sqltest/sqlmockgen/internal/tests/custom_package_name/client/v1"

	//  matching import suffix and package name
	"github.com/guzenok/go-sqltest/sqlmockgen/internal/tests/custom_package_name/validator"
)
